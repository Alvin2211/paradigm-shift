...
const Home = () => {
    return (
        <section className="relative  min-h-screen flex  overflow-hidden justify ">
            <div className="absolute inset-0 opacity-50 bg-[#f1ecff]" />
            ...
            <div className="container relative z-10 mx-auto px-4">
                <div className="grid lg:grid-cols-2 md:gap-12 items-center gap-8 ">
                    ...
                    <div className="relative w-full mx-auto mt-10 mb-5">
                        ...
                        <img src={img1} alt="Image1" className=" border-transparent rounded-2xl" />
                        </div>
